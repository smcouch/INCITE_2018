...
%===========
\vspace{0.1in} \noindent {\bf Year 1 -- Total Request: 150M \mira core-hours; 9M \thet core-hours} \todo{missing 2M core hours, text only has 148M}
%===========
...
\todo{EOC: Comment, we probably shouldn't call these magnetorotational CCSNe as that  implies high magnetic fields/high rotation and the driving explosion mechanism not neutrino powered.}
...
%===========
\vspace{0.1in} \noindent {\bf Year 2 -- Total Request: 150M \mira core-hours; 18M \thet core-hours \todo{same, only 148M in the text}}
%===========
